export const CartItem = ({ productId, title, quantity, image, lprice, isSelected }) => {
  return /* HTML */ `
    <div class="p-4 space-y-4">
      <div class="flex items-center py-3 border-b border-gray-100 cart-item" data-product-id="${productId}">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-sm text-gray-600 mt-1">${Number(lprice).toLocaleString("ko-KR")}원</p>
          <!-- 수량 조절 -->
        ...
        <div class="text-right ml-3">
          <p class="text-sm font-medium text-gray-900">${(Number(lprice) * quantity).toLocaleString("ko-KR")}원</p>
          <button
