...
`,f=`shopping_cart`,p=()=>{let e=localStorage.getItem(f);return e?JSON.parse(e):[]},m=e=>{let t=JSON.stringify(e);localStorage.setItem(f,t)},h=(e,t)=>{let n=p(),r=n.findIndex(t=>t.productId===e.productId);r===-1?n.push({...e,quantity:t||1,isSelected:!1}):n[r].quantity+=e.quantity||1,m(n)},g=e=>{try{let t=p(),n=t.filter(t=>t.productId!==e);return m(n),n}catch(e){return console.error(`장바구니에서 상품을 제거하는 중 오류가 발생했습니다:`,e),p()}},te=()=>{let e=p(),t=e.filter(e=>!e.isSelected);return m(t),t},_=(e,t)=>{try{let n=p(),r=n.findIndex(t=>t.productId===e);return r===-1?(console.error(`상품을 찾을 수 없습니다:`,e),p()):(t===`decrease`?n[r].quantity>1&&--n[r].quantity:n[r].quantity+=1,m(n),n)}catch(e){return console.error(`장바구니 수량을 변경하는 중 오류가 발생했습니다:`,e),p()}},ne=()=>{try{return localStorage.removeItem(f),[]}catch(e){return console.error(`장바구니를 비우는 중 오류가 발생했습니다:`,e),[]}},v=()=>{let e=p();return e.length},y=(e,t)=>{try{let n=p(),r=n.findIndex(t=>t.productId===e);return r!==-1&&(n[r].isSelected=t),m(n),n}catch(e){return console.error(`장바구니 선택 상태를 업데이트하는 중 오류가 발생했습니다:`,e),p()}},b=e=>{try{let t=p(),n=t.map(t=>({...t,isSelected:e}));return m(n),n}catch(e){return console.error(`장바구니 전체 선택을 업데이트하는 중 오류가 발생했습니다:`,e),p()}},x=({isBackButton:e=!1,title:t=`쇼핑몰`}={})=>{let n=v();return`
  ...
  `},S=new Map,C=(e,t)=>{S.has(e)||S.set(e,t);let n=()=>S.get(e),r=t=>{let n=S.get(e),r=typeof t==`function`?t(n):t;S.set(e,r)};return[n,r]},re=`PARAMS`,ie=`ROUTE_PARAMS`,[w,T]=C(re,new URLSearchParams(window.location.search)),[E,D]=C(ie,{}),ae=`TOAST`,[oe,O]=C(ae,{toastType:null});let k=null;const A=()=>{let e=oe();return e.toastType&&!k&&(k=setTimeout(()=>{O({toastType:null}),c(),k=null},2e3)),`
    ${e.toastType===`success`?`
          <div
    ...
    ${e.toastType===`error`?`
        ...
        `:``}
  `},se=({productId:e,title:t,quantity:n,image:r,lprice:i,isSelected:a})=>`
  ...
  `,j=()=>{let e=p(),t=v(),n=Oe().isOpen;return n?`
    <div
      ...
      ${e.length?`<div class="flex min-h-full items-end justify-center p-0 sm:items-center sm:p-4 cart-modal">
            ...
            >
              ...
              <div class="flex flex-col max-h-[calc(90vh-120px)]">
                ...
                <!-- 아이템 목록 -->
                <div class="flex-1 overflow-y-auto">${e.map(se).join(``)}</div>
                <!-- 하단 액션 -->
  ...
  `:``},ce=()=>`<div class="text-sm text-gray-500 italic">카테고리 로딩 중...</div>`,le=({category:e,depth:t})=>{let n=P();return`
    ${t===1?`
          <button
            data-category1="${e}"
...
`,pe=()=>{let e=P();return`
    ...
    <div class="grid grid-cols-2 gap-4 mb-6" id="products-grid">
      <!-- 로딩 스켈레톤 -->
      ${e.isLoading?Array.from({length:4}).map(M).join(``):e.products.map(e=>fe(e)).join(``)}
  ...
  `},N=`MAIN`,[P,F]=C(N,{products:[],isLoading:!0,isInfiniteLoading:!1,total:0,page:1,hasNext:null,categories:{},limit:w().get(`limit`)||`20`,sort:w().get(`sort`)||`price_asc`,search:w().get(`search`)||``,category1:w().get(`category1`)||``,category2:w().get(`category2`)||``}),I=()=>`
  ...
  `},ge=()=>{let{relatedProducts:e,isLoading:t}=B();return t||!e||e.length===0?``:`
  ...
  `};H.onMount=async()=>{let e=E(),t=e.id,n=await u(t);V(e=>({...e,product:n,isLoading:!1,isRelatedLoading:!0})),c();let r=await l({category2:n.category2});V(e=>({...e,relatedProducts:r.products.filter(e=>e.productId!==t),isRelatedLoading:!1})),c()},H.onUnmount=()=>{V({product:null,relatedProducts:[],isLoading:!0,quantity:1})};const ve=e=>{let t=null,n=t=>{let n=t.split(`?`)[0];return e.find(e=>{if(e.path===n)return!0;let t=e.path.split(`/`),r=n.split(`/`);return t.length===r.length?t.every((e,t)=>e.startsWith(`:`)||e===r[t]):!1})},r=(e,t)=>{let n=e.split(`/`),r=t.split(`?`)[0].split(`/`),i={};return n.forEach((e,t)=>{if(e.startsWith(`:`)){let n=e.slice(1);i[n]=r[t]}}),i},i=()=>{let e=window.location.pathname+window.location.search;return e.startsWith(`/front_6th_chapter1-1`)?e.slice(21)||`/`:e},a=async(e,i={})=>{let a=e;e.startsWith(`?`)&&(a=window.location.pathname+e),a.startsWith(`/front_6th_chapter1-1`)||(a=`/front_6th_chapter1-1`+a);let o=n(a);if(o){i.replace?window.history.replaceState({},``,a):window.history.pushState({},``,a),t=o;let e=r(o.path,a);D(e),s(o.component),o.component.onMount&&!i.isPopState&&await o.component.onMount()}else i.replace?window.history.replaceState({},``,a):window.history.pushState({},``,a),s(L)},o=async()=>{let e=i(),t=n(e);if(t){let n=r(t.path,e);D(n),s(t.component),t.component.onMount&&await t.component.onMount()}else s(L)},c=e=>{window.addEventListener(`popstate`,async()=>{e?await e():await o()})};return{init:c,navigate:a,findRoute:n,getCurrentPath:i,getRouteParams:r,currentRoute:t}},ye=[{path:`/`,component:I},{path:`/product/:id`,component:H}],U=ve(ye),be=async e=>{let t=P(),n=w();F({...t,limit:e,page:1}),n.set(`limit`,e),n.set(`page`,`1`),T(n),U.navigate(`?${n.toString()}`);let r=Object.fromEntries(n),i=await l(r);F({...t,products:i.products,page:i.pagination.page,hasNext:i.pagination.hasNext,limit:e})},xe=async e=>{let t=P(),n=w();F({...t,sort:e,page:1}),n.set(`sort`,e),n.set(`page`,`1`),T(n),U.navigate(`?${n.toString()}`);let r=Object.fromEntries(n),i=await l(r);F({...t,products:i.products,page:i.pagination.page,hasNext:i.pagination.hasNext,sort:e})},Se=async e=>{let t=P(),n=w();F({...t,search:e,page:1}),n.set(`search`,e),n.set(`page`,`1`),T(n),U.navigate(`?${n.toString()}`);let r=Object.fromEntries(n),i=await l(r);F({...t,products:i.products,page:i.pagination.page,hasNext:i.pagination.hasNext,total:i.pagination.total,search:e})},W=async(e,t)=>{let n=P(),r=w();t===1?(F({...n,category1:e,category2:``,page:1}),r.set(`category1`,e),r.delete(`category2`)):t===2?(F({...n,category2:e,page:1}),r.set(`category2`,e)):(F({...n,category1:``,category2:``,page:1}),r.delete(`category1`),r.delete(`category2`)),r.set(`page`,`1`),T(r),U.navigate(`?${r.toString()}`);let i=Object.fromEntries(r),a=await l(i);F({...n,products:a.products,page:a.pagination.page,hasNext:a.pagination.hasNext,total:a.pagination.total,category1:a.filters.category1,category2:a.filters.category2})},Ce=async(e,t,n=`/`)=>{let r=P(),i=w();F({...r,category1:e||``,category2:t||``,page:1}),e?i.set(`category1`,e):i.delete(`category1`),t?i.set(`category2`,t):i.delete(`category2`),i.set(`page`,`1`),T(i),U.navigate(`${n}?${i.toString()}`);let a=Object.fromEntries(i),o=await l(a);F({...r,products:o.products,page:o.pagination.page,hasNext:o.pagination.hasNext,total:o.pagination.total,category1:o.filters.category1,category2:o.filters.category2})},we=async e=>{let t=P(),n=w();e===`reset`?(F({...t,category1:``,category2:``,page:1}),n.delete(`category1`),n.delete(`category2`)):e===`category1`&&(F({...t,category2:``,page:1}),n.delete(`category2`)),n.set(`page`,`1`),T(n),U.navigate(`?${n.toString()}`);let r=Object.fromEntries(n),i=await l(r);F({...t,products:i.products,page:i.pagination.page,hasNext:i.pagination.hasNext,total:i.pagination.total,category1:i.filters.category1,category2:i.filters.category2})},Te=async()=>{let e=P(),t=w();if(e.isInfiniteLoading||!e.hasNext)return;F({...e,isInfiniteLoading:!0}),c();let n=e.page+1;t.set(`page`,n.toString()),T(t),U.navigate(`?${t.toString()}`,{replace:!0});let r=Object.fromEntries(t),i=await l(r);F({...e,products:[...e.products,...i.products],page:i.pagination.page,hasNext:i.pagination.hasNext,isInfiniteLoading:!1}),c()};let G=!1,K=!1;const q=async e=>{if(e.target.id===`limit-select`){let t=e.target.value;await be(t)}if(e.target.id===`sort-select`){let t=e.target.value;await xe(t)}if(e.target.closest(`#cart-modal-select-all-checkbox`)){let e=p(),t=e.every(e=>e.isSelected),n=!t;b(n)}if(e.target.classList.contains(`cart-item-checkbox`)){let t=e.target.dataset.productId,n=e.target.checked;y(t,n)}c()},J=async e=>{if(e.target.id===`search-input`&&e.key===`Enter`){let t=e.target.value;await Se(t),c()}e.key===`Escape`&&($({isOpen:!1}),c())},Y=async e=>{let t=!1;if(e.target.classList.contains(`add-to-cart-btn`)){let n=e.target.dataset.productId,r=P(),i=r.products.find(e=>e.productId===n);i&&(h(i),O({toastType:`success`}),t=!0)}if(e.target.id===`add-to-cart-btn`){let e=B(),n=e.product;n&&(h(n,e.quantity),V(e=>({...e,quantity:1})),O({toastType:`success`}),t=!0)}if(e.target.closest(`#toast-close-btn`)&&(O({toastType:null}),t=!0),e.target.classList.contains(`category1-filter-btn`)?(await W(e.target.dataset.category1,1),t=!0):e.target.classList.contains(`category2-filter-btn`)&&(await W(e.target.dataset.category2,2),t=!0),e.target.dataset.breadcrumb&&(await we(e.target.dataset.breadcrumb),t=!0),e.target.classList.contains(`breadcrumb-link`)){let n=e.target.dataset.category1,r=e.target.dataset.category2;await Ce(n,r),t=!0}if(e.target.closest(`#cart-icon-btn`)&&($({isOpen:!0}),t=!0),e.target.closest(`#cart-modal-close-btn`)&&($({isOpen:!1}),t=!0),e.target.closest(`#quantity-decrease`)&&(V(e=>({...e,quantity:e.quantity-1})),t=!0),e.target.closest(`#quantity-increase`)&&(V(e=>({...e,quantity:e.quantity+1})),t=!0),e.target.closest(`.quantity-decrease-btn`)){let n=e.target.closest(`.quantity-decrease-btn`).dataset.productId,r=_(n,`decrease`),i=document.querySelector(`[data-product-id="${n}"].quantity-input`);if(i&&r){let e=r.find(e=>e.productId===n);e&&(i.value=e.quantity)}t=!0}if(e.target.closest(`.quantity-increase-btn`)){let n=e.target.closest(`.quantity-increase-btn`).dataset.productId,r=_(n,`increase`),i=document.querySelector(`[data-product-id="${n}"].quantity-input`);if(i&&r){let e=r.find(e=>e.productId===n);e&&(i.value=e.quantity)}t=!0}if(e.target.closest(`.cart-modal-overlay`)&&!e.target.closest(`[data-modal-content]`)&&($({isOpen:!1}),t=!0),e.target.closest(`.cart-item-remove-btn`)){let n=e.target.closest(`.cart-item-remove-btn`).dataset.productId;g(n),t=!0}if(e.target.closest(`#cart-modal-remove-selected-btn`)&&(te(),t=!0),e.target.closest(`#cart-modal-clear-cart-btn`)&&(ne(),t=!0),e.target.closest(`.product-image`)||e.target.closest(`.product-info`)){let n=e.target.closest(`.product-card`).dataset.productId;U.navigate(`/product/${n}`);let r=U.findRoute(U.getCurrentPath());r.component.onMount&&r.component.onMount(),t=!0}if(e.target.closest(`.related-product-card`)){let n=e.target.closest(`.related-product-card`).dataset.productId;U.navigate(`/product/${n}`);let r=U.findRoute(U.getCurrentPath());r.component.onMount&&r.component.onMount(),t=!0}t&&c()},X=async e=>{let t=window.location.pathname;if(t!==`/`)return;let n=P();if(K||!n.hasNext)return;let r=e.target.scrollingElement||document.documentElement;if(!r)return;let{scrollTop:i,scrollHeight:a,clientHeight:o}=r;a-i<=o+100&&(K=!0,await Te(),K=!1)},Z=()=>{G||(document.removeEventListener(`change`,q),document.removeEventListener(`keydown`,J),document.removeEventListener(`click`,Y),document.removeEventListener(`scroll`,X),document.addEventListener(`change`,q),document.addEventListener(`keydown`,J),document.addEventListener(`click`,Y),window.addEventListener(`scroll`,X),G=!0)},Ee=`CART`,De=()=>r(async()=>{let{worker:e,workerOptions:t}=await import(`./browser-DvH8zzVn.js`);return{worker:e,workerOptions:t}},[]).then(({worker:e,workerOptions:t})=>e.start(t));let Q=!1;const[Oe,$]=C(Ee,{isOpen:!1}),ke=async()=>{let e=U.getCurrentPath(),t=U.findRoute(e);if(t){let n=U.getRouteParams(t.path,e);D(n),await U.navigate(e,{replace:!0,isPopState:!0})}else await U.navigate(e,{replace:!0,isPopState:!0})};async function Ae(){if(Q)return;Q=!0,o(),Z(),U.init(ke);let e=new URLSearchParams(window.location.search);T(e),e.has(`page`)&&(e.delete(`page`),T(e),await U.navigate(`?${e.toString()}`,{replace:!0}));let t=U.getCurrentPath(),n=U.findRoute(t);if(n){let e=U.getRouteParams(n.path,t);D(e),await U.navigate(t,{replace:!0})}else await U.navigate(t,{replace:!0});Q=!1}De().then(Ae);